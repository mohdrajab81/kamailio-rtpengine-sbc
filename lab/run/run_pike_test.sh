...
KPID=$!
nohup sipp -sf "$LAB_ROOT/sipp/vapi-ok.xml" -i 10.10.10.41 -p 5070 -m 200 -trace_msg -trace_err > vapi-a.out 2>&1 &
APID=$!
nohup sipp -sf "$LAB_ROOT/sipp/vapi-ok.xml" -i 10.10.10.42 -p 5080 -m 200 -trace_msg -trace_err > vapi-b.out 2>&1 &
BPID=$!
...
RC=0
sipp 10.10.10.10:5060 -sf "$LAB_ROOT/sipp/carrier-pai.xml" -i 10.10.10.20 -p 5062 -m 100 -r 50 -rp 1000 -trace_err > carrier.out 2>&1 || RC=$?
